# LICENSE AGREEMENT FOR "UNDERAUTOMATION YASKAWA .NET SDK"

IMPORTANT-READ CAREFULLY: This End-User License Agreement (the "Agreement") is a legal Agreement between you (individual, company or legal entity) and UnderAutomation for the use of "UNDERAUTOMATION YASKAWA .NET SDK". "UNDERAUTOMATION YASKAWA .NET SDK" is not for sale, it can only be licensed.
By installing, copying, or otherwise using and testing "UNDERAUTOMATION YASKAWA .NET SDK", you automatically agree to be bound by the terms of this Agreement. If you do not agree to the terms of this Agreement, do not install or use "UNDERAUTOMATION YASKAWA .NET SDK".
Any reproduction or redistribution of "UNDERAUTOMATION YASKAWA .NET SDK" or any of its components not in accordance with this Agreement is expressly prohibited by law, and may result in severe civil and criminal penalties. "UNDERAUTOMATION YASKAWA .NET SDK" is protected by the copyright law and the laws and international agreements on intellectual property rights.
...
Software is the "UNDERAUTOMATION YASKAWA .NET SDK", which includes its DLL files, documentation, examples, etc.
